...
#Region "    DWSIM Specific"
        ...
        Function ObjectCopy(ByVal obj As Reaction) As Reaction
            ...
            Return JsonConvert.DeserializeObject(Of Reaction)(json, settings)
...
#Region "    DWSIM Specific"
        ...
        Function ObjectCopy(ByVal obj As ReactionSet) As ReactionSet
            ...
            Dim json As String = JsonConvert.SerializeObject(obj, settings)
            Return JsonConvert.DeserializeObject(Of ReactionSet)(json, settings)
...
#Region "Subclasses"
    ...
    <System.Serializable()> Public Class InteractionParameter
        ...
        Function ObjectCopy(ByVal obj As InteractionParameter) As InteractionParameter
            ...
            Return Newtonsoft.Json.JsonConvert.DeserializeObject(Of InteractionParameter)(json, settings)
        End Function
    ...
    <System.Serializable()> Public Class ConstantProperties
        ...
        Function ObjectCopy(ByVal obj As ConstantProperties) As ConstantProperties
            ...
            Dim json As String = Newtonsoft.Json.JsonConvert.SerializeObject(obj, settings)
            Return Newtonsoft.Json.JsonConvert.DeserializeObject(Of ConstantProperties)(json, settings)
        End Function
        ...
        Public Sub ExportToXLSX(filepath As String) Implements ICompoundConstantProperties.ExportToXLSX
            Throw New NotSupportedException("Export to XLSX is not supported in headless mode.")
        End Sub
