Public Class Object
    ...
    Public Property SimObject As UnitOperations.Switch
    ...
    Sub UpdateInfo()
        ...
        With SimObject
            ...
            tbOffValue.Text = .OffValue

            tbOnValue.Text = .OnValue
    ...
    Private Sub tbSetPoint_TextChanged(sender As Object, e As EventArgs) Handles tbOffValue.TextChanged, tbOnValue.TextChanged
    ...
    Private Sub tbSetPoint_KeyDown(sender As Object, e As KeyEventArgs) Handles tbOffValue.KeyDown, tbOnValue.KeyDown

        If e.KeyCode = Keys.Enter And Loaded Then

            Select Case sender.Name
                Case "tbOffValue"
                    SimObject.OffValue = Double.Parse(tbOffValue.Text.ParseExpressionToDouble)
                Case "tbOnValue"
                    SimObject.OnValue = Double.Parse(tbOnValue.Text.ParseExpressionToDouble)
            End Select
