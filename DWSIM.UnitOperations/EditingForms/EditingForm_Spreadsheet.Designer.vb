...
Partial Class Object
    ...
    Private Sub InitializeComponent()
        ...
        Me.ToolTipChangeTag.SetToolTip(Me.BtnEdit, resources.GetString("BtnEdit.ToolTip1"))
        Me.ToolTipValues.SetToolTip(Me.BtnEdit, resources.GetString("BtnEdit.ToolTip2"))
        Me.BtnEdit.UseVisualStyleBackColor = True
        '
        'BtnNew
        '
        resources.ApplyResources(Me.BtnNew, "BtnNew")
        Me.BtnNew.Image = Global.DWSIM.UnitOperations.Nothing.add
        Me.BtnNew.Name = "BtnNew"
        Me.ToolTip1.SetToolTip(Me.BtnNew, resources.GetString("BtnNew.ToolTip"))
        Me.ToolTipChangeTag.SetToolTip(Me.BtnNew, resources.GetString("BtnNew.ToolTip1"))
        Me.ToolTipValues.SetToolTip(Me.BtnNew, resources.GetString("BtnNew.ToolTip2"))
        ...
        Me.dgvinputvars.DefaultCellStyle = DataGridViewCellStyle9
        ...
        Me.dgvoutputvars.DefaultCellStyle = DataGridViewCellStyle12
    ...
    Public WithEvents Column1 As DataGridViewTextBoxColumn
