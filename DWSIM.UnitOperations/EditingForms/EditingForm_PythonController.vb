...
Public Class Object
    ...
    Public Property SimObject As SpecialOps.PythonController
...
'            DirectCast(SimObject.GraphicObject, DWSIM.Drawing.SkiaSharp.GraphicObjects.Shapes.PythonControllerGraphic).ConnectedToCv = SimObject.ControlledObject.GraphicObject
    ...
    Private Sub tbSetPoint_TextChanged(sender As Object, e As EventArgs)
    ...
    Private Sub txtScript_TextChanged(sender As Object, e As EventArgs) Handles txtScript.TextChanged
        ...
        If Loaded Then SimObject.PythonScript = txtScript.Text
