...
Public Class Object
    ...
    Private Sub STHXEditorForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        With hx.STProperties
            ...
            tbShellFoulingFactor.Text = cv.ConvertFromSI(su.foulingfactor, .Shell_Fouling).ToString("G6")
            ...
            tbTubeFoulingFactor.Text = cv.ConvertFromSI(su.foulingfactor, .Tube_Fouling).ToString("G6")
            ...
            tbTubeRoughness.Text = cv.ConvertFromSI(su.diameter, .Tube_Roughness / 1000.0).ToString("G6")
